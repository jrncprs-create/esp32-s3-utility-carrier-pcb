...
**Documentatieversie:** 0.6 (placeholder)  
**Status:** KiCad placeholder v0.6 · **nog niet productieklaar** · **geen Gerbers** · ESP32-footprint blijft **NIET DEFINITIEF** (meting later · [diymore B0F3XMYYQY](https://www.amazon.nl/-/en/diymore-DevKitC-1-S3-1-N16R8-development-connectable/dp/B0F3XMYYQY))
...
## Belangrijkste ontwerpkeuzes (v0.6)
