...
| J_LED1–3 | LED strip OUT | 3 | JST-XH B2B-XH-A 3p | **Midden** op 5V pin (LED-stroom) |
...
| 1 | GND |
| 2 | 3V3 |
| 3 | 5V (5V_LOGIC tap, **geen** servo rail) |
| 4 | GPIO12 |
| 5 | GPIO13 |
| 6 | GPIO14 |
| 7 | GPIO47 |
...
| `Connector_JST:JST_XH_B2B-XH-A_1x08_P2.50mm_Vertical` | 8p |
